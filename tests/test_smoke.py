...
skill *data layer* has its own home in ``test_skill_trees.py``, and the web views
in ``test_portal.py`` -- the Skill Deck tests that used to live here moved with
the code when the deck was folded into the portal.
